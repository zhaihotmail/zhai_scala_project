...
#do git commit
os.system("git config user.email 'zhaizhongping@hotmail.com'")
os.system("git config user.name 'zhaihotmail'")
...
os.system("git remote set-url origin https://zhaihotmail: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@github.com/zhaihotmail/looker-test.git")
os.system("git push -u origin new-branch")
